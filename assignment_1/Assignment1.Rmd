...
```{r}
filtered_data <- filter(gapminder, year==1960)
p <- ggplot(filtered_data, aes(x=continent, y=population/10^6, col=continent)) + geom_boxplot() + scale_y_log10() + theme_minimal()
p
```
