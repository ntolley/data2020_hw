...
To calculate the log transformed IQR, we will first

```{r}
quantile()
```

4)  Compare (in ggplot) the countries in term of population using boxplots with two different colours for year 1960 and 2010. Try to make a plot exactly as Figure 1 (just the colour can change).
