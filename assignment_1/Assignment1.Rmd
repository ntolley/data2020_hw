...
p <- ggplot(infant_mortality_100_150, aes(x=infant_mortality)) + 
  geom_histogram(aes(y = ..density..),fill='#56B4E9', na.rm = TRUE, binwidth=1) + 
  stat_function(fun = dnorm, args = list(mean = mean_100_150, sd = sd_100_150), size=2) + 
  xlim(75, 175)
p
```
...
p <- ggplot(infant_mortality_150, aes(x=infant_mortality)) + 
  geom_histogram(aes(y = ..density..),fill='#56B4E9', na.rm = TRUE, binwidth=2) + 
  stat_function(fun = dnorm, args = list(mean = mean_150, sd = sd_150), size=2) + 
  xlim(145, 300)
p
