...
df_cov <- cov(as.matrix(df_numeric))
```

```{r}
fact_no_rot <- factanal(covmat=df_cov, factors=5, rotation="none")
fact_no_rot
```

```{r}
fact_varimax <- factanal(covmat=df_cov, factors=5, rotation="varimax")
fact_varimax
```
